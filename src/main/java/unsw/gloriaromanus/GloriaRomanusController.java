...
public class GloriaRomanusController{
  ...
  private void initializeProvinceLayers() throws JsonParseException, JsonMappingException, IOException {
    ...
    GeoPackage gpkg_provinces = new GeoPackage("src/main/java/unsw/gloriaromanus/provinces_right_hand_fixed.gpkg");
  ...
  private void addAllPointGraphics() throws JsonParseException, JsonMappingException, IOException {
    ...
    InputStream inputStream = new FileInputStream(new File("src/main/java/unsw/gloriaromanus/provinces_label.geojson"));
  ...
  private Map<String, String> getProvinceToOwningFactionMap() throws IOException {
    String content = Files.readString(Paths.get("src/main/java/unsw/gloriaromanus/initial_province_ownership.json"));
  ...
  private boolean confirmIfProvincesConnected(String province1, String province2) throws IOException {
    String content = Files.readString(Paths.get("src/main/java/unsw/gloriaromanus/province_adjacency_matrix_fully_connected.json"));
